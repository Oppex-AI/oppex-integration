...
- The uploaded artifact must be the non-executable `sdk-bundle` library, never an example application JAR.
- `.github/smoke` sources use only supported SDK API and Java 7 language syntax.
