...
GitHub Actions compiles and runs `.github/smoke/ExternalConsumer.java` directly against the `sdk-bundle` JAR, so framework examples with newer Java requirements do not block Java 7 or Java 8 compatibility jobs.
